...
def _map_binary_series(s:pd.Series) -> pd.Series:
    ...
    categorical features with exactly 2 values into 0/1 integers. The mappings are
    deterministic and must be consistent between training and serving.
    ...
    if len(vals) == 2:
        #Sort values ensure consistent mapping across runs
...
def build_features(df: pd.DataFrame, target_col: str = "Churn") -> pd.DataFrame:
    ...
    #======== Step 5: One-Hot Encoding for Multi-category Feature ======
